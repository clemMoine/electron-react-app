...
Pour faire un build sur la plateforme courante  :

```sh
npm run dist
```

Pour faire un build sur une plateforme spécifique :
...
La commande `npm run dist` est un script npm qui execute la commande `electron-builder` qui vient de la lib du même nom
[https://www.electron.build](https://www.electron.build/cli)
